...
public class SortArrayMapConsistentHashTest {
    ...
    public void getFirstNodeValue4() {
        ...
        List<String> strings = new ArrayList<String>();
        strings.add("118.89.23.102:9000:8081") ;
        strings.add("118.89.23.102:9100:9081") ;

        String process = map.process(strings,"1551253899106");

        System.out.println(process);
        Assert.assertEquals("118.89.23.102:9000:8081",process);
    }
    @Test
    public void getFirstNodeValue5() {
        ...
        strings.add("118.89.23.102:9000:8081") ;
        strings.add("118.89.23.102:9100:9081") ;
        strings.add("118.89.23.102:9100:10081") ;
    ...
    public void getFirstNodeValue7() {
        ...
        strings.add("118.89.23.102:9100:9081") ;
        strings.add("118.89.23.102:9100:10081") ;
        strings.add("118.89.23.102:9100:00081") ;
